...
<head>
    ...
    <title>Lupa Password - {{ env('APP_NAME', 'Swaratani') }}</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <div class="text-center mb-4">
            <div class="welcome-title">Lupa Password? &#x1F511;</div>
            <div class="welcome-subtitle mt-1">Masukkan email terdaftar Anda untuk menerima tautan reset password</div>
        </div>

        @if (session('status'))
            <div class="alert-custom-success mb-3 d-flex align-items-start">
                <i class="bi bi-check-circle-fill me-2 fs-5 mt-n1"></i>
            ...
            <div class="mb-4">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}"
                        placeholder="Masukkan email terdaftar Anda" required autofocus>
                </div>
            </div>
